Feature: Reader Registration
  ...
  To register in application reader goes to register form which consists only from email, password and confirm password fields
  and a button. After registration reader is logged in an ready to work with application.
